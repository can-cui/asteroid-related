...
segment=4
# delay=0.5
# exp_dir=exp/mvdr_wpe_${src_type}_${max_mics}chn_${n_src}spk_bs${batch_size}_epo${epochs}_${tag} # 4625586 4625582 4625833
# exp_dir=exp/tmp
...
exp_dir=exp/mvdr_align_8chn_1spk_bs4_epo300_over50_83250d28
