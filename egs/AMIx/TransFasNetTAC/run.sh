...
## waiting for 4349186(grele) (grue) 4561234
...
dumpdir=${data_folder}/data_clips_monoSpk_8array1_${src_type}

# Training config
epochs=500
# batch_size=4 # graffiti 2chn 4 0.84h/epo
# batch_size=3 # grele 2chn 3 2.34h/epo,
batch_size=4 # grele 3chn 2 3.5h/epo, graffiti 3chn 2 1.05h/ep
num_workers=4
half_lr=yes
early_stop=yes
patience=50
...
exp_dir=exp/dm_TransFasNet_${src_type}_${max_mics}chn_${n_src}spk_bs${batch_size}_epo${epochs}_${tag}
# exp_dir=exp/tmp
