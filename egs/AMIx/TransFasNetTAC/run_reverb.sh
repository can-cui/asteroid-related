...
dumpdir=/srv/storage/talc2@talc-data2.nancy.grid5000.fr/multispeech/calcul/users/ccui/asteroid_pl150/egs/AMIx/TAC/data/data_clips_monoSpk_8array1_${src_type} # directory to put generated json file
# Training config
# full epochs: 500
epochs=282
...
max_mics=2
segment=4
# exp_dir=exp/AMIs_TransFasNetTAC_dereverb_${src_type}_${n_src}spk_chn${max_mics}_bs${batch_size}_${tag} # 4345867
# exp_dir=exp/tmp
exp_dir=exp/AMIs_TransFasNetTAC_dereverb_align_1spk_chn2_bs2_edd76fc6
...
# exp_dir=exp/snr_data_clips_synthesis_3array1_st4k_a_bs4_epo100_3cc531ab
