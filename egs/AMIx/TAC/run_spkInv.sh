...
segment=4
# delay=0.5
exp_dir=exp/spkInv_reverbPad_${src_type}_${max_mics}chn_${n_src}spk_bs${batch_size}_epo${epochs}_${tag} # 4586718 4589972 4592142
# exp_dir=exp/tmp
...
if [[ $stage -le 3 ]]; then
	...
	mkdir -p logs
	CUDA_VISIBLE_DEVICES=$id $python_path train_spkInv.py --train_json $dumpdir/train.json \
...
# exp_dir=exp/spkInv_reverbPad_align_2chn_3spk_bs4_epo200_29095026
