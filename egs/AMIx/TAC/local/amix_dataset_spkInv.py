...
from local.dynamic_mixing import get_mix_src_ami, get_mix_src_ami_sep_123spk
import random
import sys
import torchaudio
...
class AMIxDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # else:
        chn = 2
        mixtures, sources = get_mix_src_ami_sep_123spk(chn, self.spk_dict, nmic, c_ex)
        # torchaudio.save("mixtures.wav", mixtures.cpu(), 16000, channels_first=True)
        ...
        # # torchaudio.save("src3.wav", sources[:, 2].cpu(), 16000, channels_first=True)
        # sys.exit()
