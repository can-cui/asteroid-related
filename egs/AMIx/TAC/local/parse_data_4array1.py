    ...
    for sample_dir in glob.glob(os.path.join(meeting_f, "*")):
        ...
        if len(wavs) == 24:  # check wav number, 8 mixtures, 8 spk1, 8 spk2
            for wav in wavs:
                ...
                if n_mic in [1, 2, 3] and n_mic not in c_ex.keys():
...
if __name__ == "__main__":
    ...
    out_dir = "/srv/storage/talc2@talc-data2.nancy.grid5000.fr/multispeech/calcul/users/ccui/asteroid/egs/AMIx/TAC/data_clips_synthesis_3array1_align_a"
