...
exp_dir=exp/joint_train_2ch_30epo
if [[ $stage -le 4 ]]; then
	echo "Stage 4 : Evaluation"
	CUDA_VISIBLE_DEVICES=$id $python_path eval_joint_SA_ASR.py /srv/storage/talc2@talc-data2.nancy.grid5000.fr/multispeech/calcul/users/ccui/speechbrain_0_5_14/recipes/AMI/ASR/transformer/hparams/conformer_large_MC_dereverb_saasr_retrain_load.yaml --test_json $dumpdir/test.json \
		--spk_dict $dumpdir/spk_dict.json \
