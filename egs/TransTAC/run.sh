...
## runing and waiting for run 4356206
...
n_ch=2
epochs=5
# batch_size=8 # gruss 2ch dereverb 8 6.5h/epo 7/48h
batch_size=4 # gruss 2spk 4 7.05h/epo,
# batch_size=2 # graffiti 1spk dereverb 2
# batch_size=2 # grue 1spk sep 2 8.1h/epo, 2spk sep 2 9h/epo
# batch_size=1 # graffiti 1spk sep 1 6.5h/epo
num_workers=4
# batch_size=1 # graffiti
# batch_size=2 # grue

# expdir=exp/960_dereverb_chunk50_win4_accu10_d64_bs${batch_size}_${n_src}spk_${n_ch}chn_${epochs}ep_${tag} # 1src dereverb
# expdir=exp/960_sep_chunk50_win4_accu10_d64_bs${batch_size}_${n_src}spk_${n_ch}chn_${epochs}ep_${tag} # 4338414
# expdir=exp/960_dereverb_chunk50_win4_accu10_d64_bs8_1spk_2chn_7ep_f337b68a
# expdir=exp/960_1000rir_chunk50_win4_accu10_d64_bs4_2spk_2chn_6ep_68cad18f # 4356206
expdir=exp/tmp
...
if [[ $stage -le 3 ]]; then
	...
	echo "TransTAC/TransTAC" >$expdir/publish_dir/recipe_name.txt
fi

out_dir=MC_Libri_Sen
# expdir=exp/train_TAC_f81403c4_wind32
