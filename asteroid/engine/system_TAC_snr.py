...
class System(pl.LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        """
        loss, utt_metrics = self.common_step(batch, batch_nb, train=True)
        self.log("loss", loss, logger=True)
        self.log("utt_metrics", utt_metrics, logger=True)
        return loss
    ...
    def validation_step(self, batch, batch_nb):
        ...
        Args:
            ...
            batch_nb (int): The number of the batch in the epoch.
        """
        loss, utt_metrics = self.common_step(batch, batch_nb, train=False)
        self.log("val_loss", loss, on_epoch=True, prog_bar=True)
        self.log("val_utt_metrics", utt_metrics, logger=True)
